//! WiFi configuration management with NVS storage
//!
...
///
/// ⚠️ WARNING: Changing GPIO settings can affect hardware operation.
...
impl ConfigManager {
    /// NVS namespace for storing profiles
    const NVS_NAMESPACE: &'static str = "wifikey";
    ...
    ///
    /// ⚠️ WARNING: Incorrect GPIO settings can cause hardware malfunction.
    /// Ensure you understand your hardware connections before changing.
